...
vsmApp.service('TourService', ['$http','$rootScope', function ($http, $rootScope) {
    ...
    var userhome = [
        {
            title: "Welcome",
            content: "Welcome to VSM Stock Market League. Take a tour of the game by clicking next and moving from one screen to another!Lets start by unlocking leagues and trade stocks!"
        },
        {
           path: "#/myDashboard"
        }
